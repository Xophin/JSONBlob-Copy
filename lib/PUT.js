...
function doput(req,res,body_results){
    ...
    /* 
    This was testing for integrating with the website.
    ...
    */
    ...
    switch(fs.existsSync(`./data/${filename}.json`)){
        case true: 
            ...
            res.writeHead(200,{'Content-Type':'application/jsapplication/text/htmlon'});
            // console.log("The update was successful.")
            res.write(`File ${filename} was updated with new information.`);
            break;
        case false:
