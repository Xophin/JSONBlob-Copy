...
function process(req,res){
	...
	// Writing the javascript object for Cotton Eye Joe into a pre-existing file.
	let my_new_file = 1680114779525;
	fs.writeFileSync(`./data/${my_new_file}`,timestamp+' '+json_string);
	// Read data from a file
	// console.log("Attempting read of file: 1680114779525");
	// console.log(fs.readFile(`./data/${my_new_file}`,'utf8'));
	// console.log(fs.readFileSync(`./data/${my_new_file}`,'utf8'));
