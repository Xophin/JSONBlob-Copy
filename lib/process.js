...
function process(req,res){
	...
	let my_new_file = spliturl[1];
	// console.log(my_new_file);
	// Read data from a file
	console.log(`Attempting read of file: ${my_new_file}`);
	console.log(fs.readFileSync(`./data/${my_new_file}.json`,'utf8'));
	const json_string2 = fs.readFileSync(`./data/${my_new_file}.json`,'utf8');
